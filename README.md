...
<img width="209" height="40" alt="image" src="https://github.com/user-attachments/assets/4d89ad18-99e8-4742-930c-a7c8f2b93777" />
...
<img width="588" height="698" alt="image" src="https://github.com/user-attachments/assets/c298740c-9021-4ff0-8e3a-47acff30fa5d" />


After declaring import pandas as pd, I declared the boards as pd.read_excel('board2.xlsx') to read the boards file that I downloaded, and for me to use easily, I will use it to declare for my next codes. Commanding pd.read_excel(file) will automatically read the file that I downloaded in the same folder with the same format and encoded 'board2' to print the file in tabular form.

__a. Filename: Instru = [“Name”, “GEAS”, “Electronics >70”]; where track is constant as Instrumentation and hometown Luzon__


<img width="840" height="202" alt="image" src="https://github.com/user-attachments/assets/9ed0bdd3-3c0c-48a3-a15f-3797cf95b24e" />
...
<img width="539" height="656" alt="image" src="https://github.com/user-attachments/assets/6bc2ae95-691c-42be-9735-028de0b9a008" />
...
<img width="618" height="309" alt="image" src="https://github.com/user-attachments/assets/d6aa905a-c635-497c-9640-03ba03232775" />
...
<img width="813" height="627" alt="image" src="https://github.com/user-attachments/assets/bd0c105b-fb26-46ba-9b3d-d3e0f8eebd73" />
...
<img width="815" height="594" alt="image" src="https://github.com/user-attachments/assets/c7edfc77-bf51-4d8c-bff1-cced81f9a837" />
...
<img width="811" height="614" alt="image" src="https://github.com/user-attachments/assets/55bd94ae-bef9-4587-8a37-9e033192e72e" />
